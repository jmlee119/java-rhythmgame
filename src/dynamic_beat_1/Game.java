...
public class Game extends Thread {
	...
	public void screenDraw(Graphics2D g) {
		...
		g.drawString(difficulty, 1090, 702);
	...
	public void dropNotes(String titleName) {
		...
		if (titleName.equals("Joakim Karud - Mighty Love") && difficulty.equals("Easy")) {
			...
			beats = new Beat[] {
					...
					new Beat(startTime + gap *180 , "Spae"),
					...
					new Beat(startTime + gap *266 , "Spcae"),
			...
			int startTime= 1000; // 떨어지는 주기? 시간 바꾸기
		
			beats = new Beat[] {
					new Beat(startTime, "Space") // space 키를 바꿀것
			};
		}
